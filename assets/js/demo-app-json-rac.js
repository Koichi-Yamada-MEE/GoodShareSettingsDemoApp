const demoAppJson = {
  ...
  slides: [
    ...
    },
    {
      ...
      footerContent:
        '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalRac011">リモコンを使ってエアコンを接続モードにする</a></li></ul>',
    },
    {
      index: 11,
    ...
    },
    {
      ...
      footerContent:
        '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalRac013">エアコンとスマートフォンを接続する</a></li></ul>',
    },
    {
      index: 13,
    ...
    },
    {
      ...
      footerContent:
        '<ul><li>エアコン登録と初期設定が完了しました。霧ヶ峰アプリの使い方については、霧ヶ峰アプリの取扱説明書をご確認ください。</li><li>エコモアイ搭載エアコンの場合、<a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalRac020">「次へ」</a>が表示されます。タップして操作を続けてください。</li></ul>',
    },
    {
      index: 20,
    ...
    {
      index: 31,
      imagePath: "../assets/img/rac/42-02.png",
      alt: "STEP-32",
      tooltipTarget: "targetArea32",
      tooltipDescription: '「ホームに戻る」をタップ、ホーム画面に戻る',
      footerContent:
        "<ul><li>エモコアイ搭載エアコンの登録が完了しました。</li><li>エアコン名は設置されている部屋名称に変更することをお勧めします(リビングのエアコンなど)。変更方法は、取扱説明書をご確認ください。</li></ul>",
    },
