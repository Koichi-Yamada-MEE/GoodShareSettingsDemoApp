const demoAppJson = {
  ...
  slides: [
    ...
    },
    {
      ...
      footerContent:
        '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalRac050">エアコンをアクセスポイント（APモード）にする</a></li></ul>',
    },
    {
      index: 11,
    ...
    },
    {
      ...
      tooltipDescription: "画面の内容を操作し、「次へ」をタップする",
      footerContent:
        '<ul><li><a class="footer-link" data-bs-toggle="modal" data-bs-target="#modalRac064">リモコンを使ってエアコンを接続モードにする</a></li></ul>',
    },
    {
      index: 24,
